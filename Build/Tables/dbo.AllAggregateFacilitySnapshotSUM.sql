...
GO
CREATE TABLE [dbo].[AllAggregateFacilitySnapshotSUM] (
		...
		CONSTRAINT [AllAggregateFacilitySnapshotSUM_PK]
		PRIMARY KEY
		CLUSTERED
...
GO
CREATE NONCLUSTERED INDEX [IDX_AllAggregateFacilitySnapshotSUM_ProductID_R4QTimeframeKey_Includes]
	ON [dbo].[AllAggregateFacilitySnapshotSUM] ([ProductID], [R4QTimeframeKey])
	...
	ON [PS_AggregationKey] ([AggregationKey])
GO
ALTER TABLE [dbo].[AllAggregateFacilitySnapshotSUM] SET (LOCK_ESCALATION = TABLE)
GO

...
GO
CREATE TABLE [dbo].[AllAggregateSnapshotSUM] (
		...
		CONSTRAINT [AllAggregateSnapshotSUM_PK]
		PRIMARY KEY
		CLUSTERED
...
CREATE NONCLUSTERED INDEX [IDX_AllAggregateSnapshotSUM_ProductID_R4QTimeframeKey_Inclues]
	ON [dbo].[AllAggregateSnapshotSUM] ([ProductID], [R4QTimeframeKey])
	...
	ON [PS_AggregationKey] ([AggregationKey])
GO
ALTER TABLE [dbo].[AllAggregateSnapshotSUM] SET (LOCK_ESCALATION = TABLE)
GO

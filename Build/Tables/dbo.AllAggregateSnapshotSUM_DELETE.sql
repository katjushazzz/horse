...
GO
CREATE TABLE [dbo].[AllAggregateSnapshotSUM_DELETE] (
		...
		CONSTRAINT [AllAggregateSnapshotSUM_DELETE_PK]
		PRIMARY KEY
		CLUSTERED
...
CREATE NONCLUSTERED INDEX [IDX_AllAggregateSnapshotSUM_ProductID_R4QTimeframeKey_Inclues]
	ON [dbo].[AllAggregateSnapshotSUM_DELETE] ([ProductID], [R4QTimeframeKey])
	INCLUDE ([AggregationKey], [MetricKey], [SnpsAllR4QDenominator], [SnpsAllR4QNumerator], [SnpsAllR4QPercentage], [SnpsPctl0], [SnpsPctl10], [SnpsPctl100], [SnpsPctl15], [SnpsPctl25], [SnpsPctl5], [SnpsPctl50], [SnpsPctl75], [SnpsPctl85], [SnpsPctl90], [SnpsPctl95])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[AllAggregateSnapshotSUM_DELETE] SET (LOCK_ESCALATION = TABLE)
GO

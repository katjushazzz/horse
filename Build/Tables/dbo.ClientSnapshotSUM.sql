...
GO
CREATE TABLE [dbo].[ClientSnapshotSUM] (
		[AggregationKey]                [int] NOT NULL,
		[MetricKey]                     [int] NOT NULL,
		[ClientKey]                     [int] NOT NULL,
		[ClientSnapshotKey]             [bigint] IDENTITY(1, 1) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IDX_ClientSnapshotSUM_AggregationKey_R4QTimeframeKey_Clientkey]
	ON [dbo].[ClientSnapshotSUM] ([AggregationKey], [R4QTimeframeKey], [ClientKey])
	ON [PS_AggregationKey] ([AggregationKey])
GO
ALTER TABLE [dbo].[ClientSnapshotSUM] SET (LOCK_ESCALATION = TABLE)
GO

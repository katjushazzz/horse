...
GO
CREATE TABLE [dbo].[ComparisonGroupSnapshotSUM] (
		...
		CONSTRAINT [PK_ComparisonGroupSnapshotSUM]
		PRIMARY KEY
		CLUSTERED
...
GO
ALTER TABLE [dbo].[ComparisonGroupSnapshotSUM] SET (LOCK_ESCALATION = TABLE)
GO

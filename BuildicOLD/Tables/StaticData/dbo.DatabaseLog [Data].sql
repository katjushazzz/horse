...
INSERT [dbo].[DatabaseLog] ([DatabaseLogID], [PostTime], [DatabaseUser], [Event], [Schema], [Object], [TSQL], [XmlEvent]) VALUES (1, CAST(N'2017-10-27T14:33:01.390' AS DateTime), N'dbo', N'CREATE_TABLE', N'dbo', N'ErrorLog', N'CREATE TABLE [dbo].[ErrorLog](
...
INSERT [dbo].[DatabaseLog] ([DatabaseLogID], [PostTime], [DatabaseUser], [Event], [Schema], [Object], [TSQL], [XmlEvent]) VALUES (2, CAST(N'5017-10-27T14:33:01.390' AS DateTime), N'dbo', N'CREATE_TABLE', N'dbo', N'ErrorLog', N'CREATE TABLE [dbo].[ErrorLog](
    [ErrorLogID] [int] IDENTITY (1, 1) NOT NULL,
    [ErrorTime] [datetime] NOT NULL CONSTRAINT [DF_ErrorLog_ErrorTime] DEFAULT (GETDATE()),
    [UserName] [sysname] NOT NULL, 
    [ErrorNumber] [int] NOT NULL, 
